 ...
 */
export default class MiddlewareModule extends AbstractModule {
  /** @override */
  async init() {
...
function checkUploadedFiles(expectedFileTypes, filesToCheck) {
  ...
  if(invalidFiles.length) {
    throw new Error(App.instance.lang.t('error.unexpectedtype', { types: expectedFileTypes, files: invalidFiles }));
  }
}
/** @ignore */
